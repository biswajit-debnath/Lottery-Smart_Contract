...
contract HelperConfigTest is Test {
    ...
    function testGetSepoliaNetworkConfig() public {
        ...
        assertEq(config.vrfCoordinatorAddress, 0x9DdfaCa8183c41ad55329BdeeD9F6A8d53168B1B, "Incorrect VRF coordinator address for Sepolia");
        assertEq(config.keyHash, 0x787d74caea10b2b357790d5b5247c2f63d1d91572a9846f780606e4d953677ae, "Incorrect key hash for Sepolia");
    ...
    function testGetLocalAnvilNetworkConfig() public {
        ...
        assertEq(config.keyHash, 0x474e34a077df58807dbe9c96d3c009b23b3c6d0cce433e59bbf5b34f823bc56c, "Incorrect key hash for local chain");
    ...
    function testGetConfigByChainId() public {
        ...
        assertEq(sepoliaConfig.vrfCoordinatorAddress, 0x9DdfaCa8183c41ad55329BdeeD9F6A8d53168B1B, "Incorrect VRF coordinator address for Sepolia");
